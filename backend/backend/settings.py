...
SECRET_KEY = 'django-insecure-x47ua3%lcogtz_q9%#k4fr2_*nz6^+hk5qdq4@lmfg1y-^ox(w'
...
# Frontend URL (for PayPal redirect URLs)
...
LOGGING = {
    ...
    'loggers': {
        'store': {'handlers': ['console'], 'level': 'DEBUG', 'propagate': False},
    },
}
